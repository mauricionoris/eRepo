  ...
  self = {
    init: function (containerSelector, controllerName) {
      ...
      return driver.executeScript(function () {
        window.view = require('consoleAdm-view')(arguments[0], window[arguments[1]]);
    ...
    addActionForm: function () {
     return newFormView(driver, driver.findElement({
        css: containerSel + ' .detail form.actionsForm'
      }));
    }
  };
